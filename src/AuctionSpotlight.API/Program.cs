...
using AuctionSpotlight.API.Repositories;
using AuctionSpotlight.API.Repositories.DataAccess;
...
builder.Services.AddDbContext<AuctionSpotlightDbContext>(options =>
{
    options.UseSqlite(@"Data Source=C:\Projetos\leilaoDbNLW.db");
});
